...
#define dbgCtlFirstCustomOp	0x8000		// log.handlers begin numbering their op[erations]
...
// Debug control function for implementing debug tracing, etc. via log.handlers.
// The default implementation does nothing, leaving the real work up to "log.handlers".
